...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
   <title>Admin Dashboard - Food Menu</title>
...
?>
    <div class="fetching">
        ...
        <a href="confirm_delete.php?sdid=<?php echo $id ?>"><button>Delete</button></a>

         <a href="adminviewcomment.php?adid=<?php echo $id ?>"><button>View Comment</button></a>
    </div>
<?php } ?>
</div>
